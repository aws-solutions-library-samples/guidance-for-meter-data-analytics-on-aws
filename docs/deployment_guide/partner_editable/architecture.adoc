...
** Partitioned business data converted by AWS Glue crawler.
...
* AWS Glue crawlers to transform meter data from MDM and HES systems into clean and partitioned business data.
